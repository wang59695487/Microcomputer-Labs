...
;《敢问路在何方》简谱中每个音符及节拍的编码表，高四位为简谱编码，低四位为节拍（基本delay的个数）
TABLE:	DB 22H,44H,22H,66H,52H,52H,46H,48H,32H,24H,32H,56H,62H
		DB 42H,26H,28H,68H,96H,62H,94H,82H,72H,68H,46H,52H,64H,72H,62H
		DB 5FH,51H,24H,64H,52H,62H,24H,4CH,64H,52H,34H,62H,52H,22H,42H,52H
		DB 6FH,61H,68H,96H,62H,94H,82H,72H,68H,82H,54H,72H,62H,52H,44H
		DB 5CH,64H,52H,34H,62H,32H,22H,14H,2FH,21H,00H

;简谱频率表
TABLE1: DB 00H,00H,0FBH,04H,0FBH,92H,0FCH,0CH  ;不发音，低音5-低音7
